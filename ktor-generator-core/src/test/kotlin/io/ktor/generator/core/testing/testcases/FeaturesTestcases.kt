...
/**
 * Simple feature, no complications.
 * */
val CORS_FEATURE = FakeFeature(
    id = "cors",
    name = "CORS",
    description = "Cross-Origin Resource Sharing support.",
    vendor = KtorPluginVendor.JetBrains,
    requiredFeatures = listOf(),
    documentation = KtorFeatureDocumentation(
        description = """
    ...
    installReceipt = FeatureInstallReceipt(
        imports = listOf("io.ktor.features.*"),
        installBlock = """
            install(CORS) {
                method(HttpMethod.Options)
 ...
 * */
val LOCATIONS_FEATURE = FakeFeature(
    id = "ktor-locations",
    name = "Locations",
    description = "Allows to define route locations in a typed way.",
    vendor = KtorPluginVendor.JetBrains,
    requiredFeatures = listOf("routing"),
    documentation = KtorFeatureDocumentation(
        description = """
    ...
    installReceipt = FeatureInstallReceipt(
        imports = listOf("io.ktor.locations.*"),
        installBlock = "install(Locations)",
        extraTemplates = listOf(
            CodeTemplate(
                position = CodeTemplate.Position.INSIDE_APPLICATION_MODULE,
                text = """
                    routing {
            ...
            CodeTemplate(
                position = CodeTemplate.Position.OUTSIDE_APPLICATION_MODULE,
                text = """
    ...
    testInstallReceipt = FeatureInstallReceipt(
        imports = listOf(
 ...
 * - test templates
 * */
val ROUTING_FEATURE = FakeFeature(
    id = "routing",
    name = "Routing",
    description = "Simplify and structure page request handling.",
    ...
    testInstallReceipt = FeatureInstallReceipt(
        ...
        extraTemplates = listOf(
            CodeTemplate(
                position = CodeTemplate.Position.TEST_FUNCTION,
                text = """
                    @Test
                    fun testRoot() {
...
class FakeFeature(
    ...
    override val vendor: KtorPluginVendor,
    override val requiredFeatures: List<String>,
    override val documentation: KtorFeatureDocumentation?,
    override val installReceipt: FeatureInstallReceipt,
    override val testInstallReceipt: FeatureInstallReceipt?
) : KtorFeature

val NO_FEATURES = Features.create(Engine.NETTY, emptyList())

val SINGLE_SIMPLE_FEATURE = Features.create(Engine.NETTY, listOf(CORS_FEATURE))

val THREE_FEATURES = Features.create(Engine.NETTY, listOf(CORS_FEATURE, LOCATIONS_FEATURE, ROUTING_FEATURE))